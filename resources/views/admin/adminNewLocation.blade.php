        ...
        <div class="row d-flex justify-content-center">
            <div class="row dt-content mt-5">
                <div class="col-md-12 text-right mb-5 d-flex justify-content-between">
                    <h1 class="mt-0 fredoka">New Location Management</h1>
                </div>
                <div class="col-md-12">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('adminNewLocation.index') }}",
                columns: [
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                if(result){
                    $.ajax({
                        type: "GET",
                        url: "{{ route('adminNewLocation.store') }}"+'/'+user_id +'/edit',
            ...
            $('body').on('click', '.deleteProduct', function (){
                ...
                if(result){
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('adminLocation.store') }}"+'/'+user_id,
                        success: function (data) {
                            table.draw();
                        },
                        error: function (data) {
