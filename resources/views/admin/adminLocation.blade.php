        ...
        <div class="row d-flex justify-content-center">
            <div class="row dt-content mt-5">
                <div class="col-md-12 text-right mb-5 d-flex justify-content-between">
                    ...
                    <div>
                        <a class="btn btn-primary mt-3" href="adminNewLocation" id="user_approve"><i class="fa fa-unlock-alt" aria-hidden="true"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <!-- <div class="form-group">
                            <label for="email" class="col-sm-12 control-label">Contact Email</label>
                            <div class="col-12">
                                <input type="email" id="email" name="email" placeholder="Enter Contact Email" class="form-control" required>
                            </div>
                        </div> -->
