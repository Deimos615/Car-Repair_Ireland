...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<h2 style="text-align: center; font-weight: 600;">{{ $name }} requested a quote for getting following services</h2>
            				<h5 style="color: grey; text-align: right;">To the Autoguru Maintenance and Repair Service</h5>
            			</div>
            		</td>
            	</tr>
            </table>
					  ...
					  <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  	<td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
					  		<div class="product-entry">
					  			<!-- <img src="images/prod-1.jpg" alt="" style="width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;"> -->
					  			<div class="text">
					  				<h2 style="font-weight: 600;">Requested Services</h2>
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
                        <td style="text-align: left; padding-left: 10px;">
                          <ul>
                            @foreach($detailArray as $key => $data)
                              <li>{{ $data }}</li>
                            @endforeach
                          </ul>
                        </td>
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
        ...
        <tr>
          <td class="bg_white" style="text-align: center; color: grey; background: #f1f1f1;">
