        ...
        <!-- Page Content -->
            <div id="page-content-wrapper">
                <nav class="navbar navbar-expand-lg navbar-light border-bottom">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}"><img class="logo-img" src="{{ asset('images/logo/logo.png') }}" alt="logo image"></a>    
                    ...
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        <li class="list-group list-group-flush d-flex mr-5" style="border-bottom:none!important; flex-flow: row;">
                            ...
                            <a href="adminUser" class="list-group-item list-group-item-action">Clients</a>
                            ...
                            <a href="adminTransport" class="list-group-item list-group-item-action">Transport</a>
                            <a href="adminSell" class="list-group-item list-group-item-action">Sell</a>
                            <a href="adminPurchase" class="list-group-item list-group-item-action">Purchase</a>
