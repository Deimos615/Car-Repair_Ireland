...
@section("content")
                ...
                <div class="db-field">
                  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                      <li class="nav-item" role="presentation">
                          <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Upcoming Bookings</button>
                      </li>
                      <li class="nav-item" role="presentation">
                                  ...
                                  <td>
                                    @if($updata->deposit == '')
                                      <button type="button" class="btn btn-success payment-btn payment-button" data-bs-toggle="modal" data-bs-target="#payModal">
                                        <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Please pay a deposit to secure your booking in the maintenance & repair section">
    ...
    <script>
      ...
      var tooltipList = tooltipTriggerList.map(function(tooltipTriggerEl) {
        // Your code to manipulate each element goes here
        ...
        $('#submit_reply').on('click', function(e){
          ...
          $.ajax({ 
            ...
            success: function(data) {
              if(data.status == '2') {
                Command: toastr["success"]("Secure your slot today with by paying a deposit.", "Submitted successfully!");
                setTimeout(() => {
                  location.reload();
                  return false;  
                }, 3000);
