        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
              type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Previous Booking</button>
          </li>
        </ul>
            ...
            <table class="table table-hover">
              <thead class="table-title">
                <tr class="quote-tr">
                  ...
                  <th class="new-exchange-icon"><i class="fa fa-bullhorn"></i></th>
                  <th>Reply</th>
                  <th>Deposit</th>
                </tr>
              </thead>
              @if($upcomingBooking != 0 )
                @foreach($up_bookings as $key => $updata)
                  <tbody>
          ...
          <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <table class="table table-hover">
              ...
              @if(!empty($pastBooking))
                @if($pastBooking == 1 && empty($pre_bookings[0]))
                  <tbody>
                    <tr>
                      <td colspan="8">No data available.</td>
                    </tr>
                ...
                @else
                  @foreach($pre_bookings as $key => $predata)
                    <tbody>
...
$('#submit_reply').on('click', function(e) {
  ...
  $.ajax({
    type: 'POST',
    url: "{{ route('manager.managerBookingReply') }}",
    data: {
      _token: _token,
      quote_id: quote_id,
      garage_id: garage_id,
