    ...
    <section class="container dashboard">
        <div class="dashboard-area">
            ...
            <div class="db-content col-lg-9 col-md-7 col-sm-12 col-12">
                <div class="db-top">
                    <h3 class="fredoka">
                        Pre-Purchase to {{ Auth::user()->name }}
                    </h3>
                    <!-- <div>
                                        ...
                                        <div class="basic-service col-lg-7 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="service-area">
                                                <div class="service-content">
                                                    <img class="ser-img" src="{{ asset('images/small/dashboard/user.png') }}">
                                                    <p class="ser-text">{{$data->name}}</p>
                                                </div>
                                                <div class="service-content">
                                                    <img class="ser-img" src="{{ asset('images/small/dashboard/mail.png') }}">
                                                    <p class="ser-text">{{$data->email}}</p>
                                                </div>
                                                <div class="service-content">
                                        ...
                                        <div class="post-service col-lg-5 col-md-12 col-sm-12 col-12">
                                            <div class="post-serarea">
                                                <div class="post-text1">
                                                    <p class="post-title">Prefer time</p>
                                                ...
                                                <div class="post-text3">
                                                    ...
                                                    @if($data->inspection == 'Standard')
                                                        <p class="post-cost">€ 139</p>
                                                    @else
                                                        <p class="post-cost">€ 189</p>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
