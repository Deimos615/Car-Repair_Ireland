      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<h2 style="text-align: center; font-weight: 600;">{{ $name }} requested a Pre-Purchase Inspection</h2>
            				<h5 style="color: grey; text-align: right;">To the Autoguru Pre-Purchase Inspection Service</h5>
            			</div>
            		</td>
            	</tr>
            </table>
	      ...
	      <tr>
            ...
            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                    ...
                    <p>Seller Phone Number: <span style="color:#17bebb">{{ $seller_phone }}</span></p>
					  			</div>
					  		</div>
					  	</td>
					  </tr>
                    ...
                    <p>Location: <span style="color:#17bebb;">{{ $location }}</span></p>
                    <p>Garage: <span style="color:#17bebb">{{ $garage }}</span></p>
                    <p>Date: <span style="color:#17bebb">{{ $date }}</span></p>
                    <p>Preferred Time: <span style="color:#17bebb">{{ $prefer_time }}</span></p>
                    <p>Level of Inspection: <span style="color:#17bebb">{{ $inspection }}</span></p>
					  			</div>
					  		</div>
					  	</td>
					  </tr>
					  	...
					  	<td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
					  		<div class="product-entry">
					  			...
					  			<div class="text">
					  				...
					  				<p>Reg Number: <span style="color:#17bebb">{{ $reg }}</span></p>
